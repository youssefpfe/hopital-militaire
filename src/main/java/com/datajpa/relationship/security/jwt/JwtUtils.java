...
public class JwtUtils {
  ...
  public ResponseCookie generateJwtCookie(UtilisateurDetailsImpl utilisateurPrincipal) {
    String jwt = generateTokenFromUsername(utilisateurPrincipal.getUsername());
